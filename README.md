...
20 exercices de bases sont fournis (se limitant à l'utilisation de boucle de répétition non imbriquées). Ils sont disponibles dans les dossiers `exercices/sujets` et `exercices/corrections`.
